...
@section('content')
<p>
    @include('legal.partials.field', ['key' => 'company', 'label' => 'Şirket Ünvanı']) ("Reserup") olarak
...
<ul>
    ...
    <li><strong>Ödeme verileri:</strong> abonelik/ödeme kayıtları. Kart bilgileri Reserup tarafından
...
<p>
    ...
    Reserup bu verileri işletme adına işleyen (veri işleyen) sıfatıyla saklar ve işler. İşletmeler,
